...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="margin-bottom: 20px">Preset</h1>
      <a href="{{route('preset.create')}}">
        ...
        <table id="table" style="width: 100%">
            ...
            <tbody>
                @foreach($presets as $preset)
                    <tr>
                        <td>{{$preset['nome']}}</td>
                        <td>{{$preset['residencia']}}</td>
                        <td>{{$preset['telefone']}}</td>
                        <td style="width: 200px">
                            
                            <form action="{{ route('preset.destroy', $preset['id']) }}" method="post">
                                <a href="{{route('preset.edit', $preset['id'])}}">
