...
<head>
  ...
  <title>Loja Golgari - Preset</title>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="margin-bottom: 20px">Preset - Cadastro</h1>
    ...
    <section class="section dashboard" style="margin-top: 40px">
      <div class="row">
        ...
        <form action="{{route('preset.update', $preset['id'])}}" method="POST">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="residencia" id="residencia" style="width: 500px"
                    maxlength="50"
                    value="{{$preset['residencia']}}"
                    required>
            </div>
        
            <div>
              <label for="telefone" >Telefone</label>
              <input type="text" name="telefone" id="telefone" style="width: 500px"
                  maxlength="50"
                  value="{{$preset['telefone']}}"
                  required>
          </div>
