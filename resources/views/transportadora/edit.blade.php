...
<head>
  ...
  <title>Loja Golgari - Transportadora</title>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="margin-bottom: 20px">Transportadora - Cadastro</h1>
      ...
      <div class="row">
        ...
        <form action="{{route('transportadora.update', $transportadora['id'])}}" method="POST">
            ...
            <div>
                ...
                <input type="text" name="nome" id="nome" style="width: 500px"
                    maxlength="50"
            ...
            <div>
                <label for="numerofrota" >Numero da frota</label>
                <input type="text" name="numerofrota" id="numerofrota" style="width: 500px"
                    maxlength="50"
                    value="{{$transportadora['numerofrota']}}"
                    required>
            </div>
        
            <div>
              <label for="descricao" >Zona de atendimento</label>
              <input type="text" name="zonaatendimento" id="zonaatendimento" style="width: 500px"
                  maxlength="50"
                  value="{{$transportadora['zonaatendimento']}}"
                  required>
          </div>
