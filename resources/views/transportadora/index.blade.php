...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="margin-bottom: 20px">Transportadora</h1>
      <a href="{{route('transportadora.create')}}">
            ...
            <tbody>
                @foreach($transportadoras as $transportadora)
                    <tr>
                        ...
                        <td>{{$transportadora['numerofrota']}}</td>
                        <td>{{$transportadora['zonaatendimento']}}</td>
                        <td style="width: 200px">
                            
                            <form action="{{ route('transportadora.destroy', $transportadora['id']) }}" method="post">
                                <a href="{{route('transportadora.edit', $transportadora['id'])}}">
