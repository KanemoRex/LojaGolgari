...
<head>
  ...
  <title>Loja Golgari - Pedido</title>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="margin-bottom: 20px">Pedido - Cadastro</h1>
      ...
      <div class="row">
        ...
        <form action="{{route('pedido.update', $pedido['id'])}}" method="POST">
            ...
            <div>
                ...
                <input type="text" name="datapedido" id="datapedido" style="width: 500px"
                    maxlength="50"
            ...
            <div>
                ...
                <input type="text" name="nf" id="nf" style="width: 500px"
                    maxlength="50"
                    value="{{$pedido['nf']}}"
                    required>
            </div>
            ...
            <div>
              ...
              <select multiple name="produto[]" id="produto" style="width: 500px">
                  @foreach ($produtos as $produto)
                    <option value="{{$produto->id}}" @foreach ($pedidoprodutos as $pedidoproduto)
                      @if ($pedidoproduto->produto_id == $produto->id)
                        selected
                      @endif
                    @endforeach>{{$produto->nome}}</option>
                  @endforeach
              </select>
          </div>
